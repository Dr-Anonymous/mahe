...
for (var i=0; i< e.length; i++){ //individual file
	...
	$('#pics').append("<div class='col s4'><video class='responsive-video' width='"+ dimen["width"] +"' height='"+ dimen["height"] +"' poster='"+link+"' preload='none' controls='true' playsinline onclick='play();'><source src='"+link+"=dv' type='"+mimeType+"'></video><p class='flow-text truncate' style='width:"+ dimen["width"]*60/100 +"px;'>"+ e[i]["filename"] +"</p></div>");
	else
